...
* __Hormone (proportional hazards interpretation)__: We estimate that women with breast cancer who receive hormone therapy die at a rate that is e^(-0.2808/0.758)^ = `r format(exp(-0.2808/0.758), digits=4)` times that of women with breast cancer who receive hormone therapy, holding all else in the model constant.
